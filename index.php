            ...
            <div class="col-lg-6">
                <div class="rts-hero__content w-550">
                    ...
                    <p data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                        <img src="assets/images/icon/dollar.svg" alt="">Starting from <span>₹299</span> per month
                    </p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="rts-hero__images position-relative">
                    <div class="rts-hero-main">
                        <div class="image-main">
                            <img class="main top-bottom2"
                                src="assets/images/home/Untitled_design__3_-removebg-preview.png" alt="">
                        </div>
            ...
            <div class="col-lg-6 col-md-11">
                <div class="feature__image py-5 d-flex align-items-center justify-content-center me-lg-5 me-md-0">
                    <figure class="feature__thumb">
                        <img src="assets/images/index-11/section-4.png" alt="About Code Agni">
                    </figure>
                </div>
            </div>
                ...
                <div class="rts-about__content">
                    ...
                    <div class="rts-about__content--single" data-sal="slide-down" data-sal-delay="600"
                        ...
                        <div class="image bg-2">
                            <img src="assets/images/about/02.svg" alt="Subscription Model">
                        </div>
                    ...
                    <div class="rts-about__content--single" data-sal="slide-down" data-sal-delay="500"
                        data-sal-duration="800">
                        <div class="image">
                            <img src="assets/images/about/01.svg" alt="Custom Software">
                        </div>
                        <div class="description">
        ...
        <div class="row g-30">
            <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                <div class="cloud-feature">
                    ...
                    <p class="description">
                        No surprise charges or hidden fees! Only ₹299/month for a fully functional 5-page website.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                                ...
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 3 Pages</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Create up to 3 pages for your website."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Mobile-Friendly
                                                Design</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Your website will be optimized for mobile devices."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Free Hosting &
                                                Domain</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Enjoy free hosting and a custom domain for your website."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Basic SEO
                                                Optimization</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Basic search engine optimization to improve your website's visibility."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> SSL
                                                Certificate</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Secure your website with an SSL certificate."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Blog
                                                Integration</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Blog functionality is not included in this plan."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> E-Commerce
                                                Features</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="E-commerce functionality is not included in this plan."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Payment Gateway
                                                Integration</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Payment gateway integration is not included in this plan."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="card-plan style-with-bg active">
                            <div class="card-plan__content">
                                ...
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 5 Pages</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Create up to 5 pages for your website."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Mobile-Friendly
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Blog
                                                Integration</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Add a blog to your website."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> E-Commerce
                        ...
                        <div class="card-plan style-with-bg">
                            <div class="card-plan__content">
                                ...
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Dynamic Pages</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Create dynamic pages for your website."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Mobile-Friendly
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> E-Commerce
                                                Features</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Add e-commerce functionality to your website."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Payment Gateway
                                                Integration</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                data-bs-original-title="Integrate payment gateways for seamless transactions."><i
                                                    class="fa-light fa-circle-question"></i></span>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="col-12 d-flex justify-content-center">
                <div class="rts-section  text-center">
                    ...
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="400"
                        ...
                        website performance. We empower businesses with modern, responsive, and efficient web development solutions.</p>
                </div>
            </div>
        </div>
        <!-- testimonial -->
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="rts-testimonial__single">
                                ...
                                <div class="content">
                                    <p>Excellent web development service! They helped transform our online presence, ensuring a fast and responsive website for our clients.</p>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="rts-testimonial__single">
                                ...
                                <div class="content">
                                    <p>Incredible support and seamless integration! Their team helped us develop a website that is not only functional but also visually stunning.</p>
                                </div>
                                <div class="author__meta">
                                    <div class="author__meta--image">
                        ...
                        <div class="swiper-slide">
                            <div class="rts-testimonial__single">
                                ...
                                <div class="content">
                                    <p>Our website now works perfectly across all devices, thanks to their expertise. Highly recommend their web development services!</p>
                                </div>
                                <div class="author__meta">
                                    <div class="author__meta--image">
                        ...
                        <div class="swiper-slide">
                            <div class="rts-testimonial__single">
                                ...
                                <div class="content">
                                    <p>Working with this team was an absolute pleasure! They created a user-friendly website for our business, and the results have been fantastic.</p>
                                </div>
                                <div class="author__meta">
                                    <div class="author__meta--image">
                                        <img src="assets/images/testimonials/author.png" alt="">
                ...
                <div class="rts-faq__accordion">
                    <div class="accordion accordion-flush" id="rts-accordion">
                        <div class="accordion-item" data-sal="slide-left" data-sal-delay="300" data-sal-duration="800">
                            ...
                            <div id="item__one" class="accordion-collapse collapse" aria-labelledby="first"
                ...
                <div class="rts-cta__right">
                    <div class="cta-image">
                        <div class="cta-image__one">
                            <img src="assets/images/cta/cta__hosting.svg" alt="Hosting">
                        </div>
                        <div class="cta-image__two">
                            <img src="assets/images/cta/cta__person.svg" alt="Person">
                        </div>
                    </div>
                </div>
            </div>
