...
<div class="container-scroller">
    ...
    ?>
            <tr>
                ...
                <td>
                    <label class="badge <?php echo $row['status'] == 'active' ? 'badge-success' : 'badge-warning'; ?>">
                        <?php echo htmlspecialchars($row['status']); ?>
                    </label>
                </td>
                <td>
                    <a href="edit-brand.php?id=<?php echo htmlspecialchars($row['id']); ?>">
                        <i style="font-size: 19px; color: #4b49ac;" class="mdi mdi-pencil"></i>
                    </a>
                    <a href="#" class="delete-brand" data-id="<?php echo htmlspecialchars($row['id']); ?>">
