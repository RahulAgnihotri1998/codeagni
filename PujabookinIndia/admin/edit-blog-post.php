            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="add-brands.php">Add Puja Category</a></li>
...
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="card img-box">
                                                <img style="width:70px; height:70px;" src="./images/blog/<?php echo $rows['featuredimage'] ?>" alt="">
                                            </div>
